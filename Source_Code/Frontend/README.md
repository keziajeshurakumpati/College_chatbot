...
## Authentication
The frontend includes Firebase Authentication for Google sign-in and phone OTP.
The Firebase web configuration is contained in `src/firebase.ts`. Real phone SMS may require Firebase billing; Google sign-in does not require phone SMS billing.
